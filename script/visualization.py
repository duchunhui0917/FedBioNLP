...
parser.add_argument('--GSN', default=False)
parser.add_argument('--mlm_method', default='subtree', choices=['None', 'subtree', 'all'])
parser.add_argument('--mlm_prob', default=0.15)
parser.add_argument('--num_gcn_layers', type=int, default=0)
parser.add_argument('--K_LCA', type=int, default=1)
...
ckpt = f'ckpt/{args.alg}/{args.dataset_name}/{model_name}_global'
...
if os.path.exists(rep) and args.load_rep:
    ...
    ls = []
    for i, test_loader in enumerate(cs.train_loaders):
