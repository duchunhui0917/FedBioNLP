...
res = process_dataset(args.dataset_name, split_type='idx_split', model_name=args.model_name, MaskedLM=True)
...
p = f'ckpt/MaskedLM/{args.dataset_name}_{model_name}'
