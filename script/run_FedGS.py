...
from FedBioNLP.systems import FedGSSystem
import argparse
...
parser.add_argument('--alg', default='FedGS',
...
p_ckpt = f'ckpt/{args.alg}/{args.dataset_name}_{model_name}.pth'
p_grad_cos = f'grad_cos/{args.alg}/{args.dataset_name}_{model_name}.json'
ckpt = os.path.join(base_dir, p_ckpt)
grad_cos = os.path.join(base_dir, p_grad_cos)

cs = FedGSSystem(client_ids, train_datasets, test_datasets, train_dataset, test_dataset, model, device,
                 ckpt, grad_cos,
